...
class VoiceCallPage extends StatefulWidget {
  ...
  const VoiceCallPage({Key? key, required this.role, this.onMessageSent})
    : super(key: key);
...
class _VoiceCallPageState extends State<VoiceCallPage> {
  ...
  Future<void> _playCallSound() async {
    ...
    try {
      ...
      await _audioPlayer.play(AssetSource('images/wechatCall.mp3'));
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        CircleAvatar(
                          backgroundImage: AssetImage(widget.role.avatar),
                          radius: 24,
                        ),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          colors: [Color(0xFF7F7FFF), Color(0xFFF9CFE6)],
